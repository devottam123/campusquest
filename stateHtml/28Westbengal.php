...
<head>
    ...
    <style>
        body {
            background: url('../states/westbengal.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [88.03867726874915,24.822014605101813], // starting position [lng, lat]
        zoom: 6, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='west bengal'";
