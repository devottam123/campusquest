...
<head>
    ...
    <style>
        body {
            background: url('../states/uttarakhand.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [79.2075225812041, 30.188792184035663], // starting position [lng, lat]
        zoom: 7.1, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='uttarakhand'";
