...
<head>
    ...
    <style>
        body {
            background: url('../states/delhi.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [77.1090060882868, 28.653894095321484], // starting position [lng, lat]
        zoom: 9.5, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='delhi'";
