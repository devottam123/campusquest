...
<head>
    ...
    <style>
        body {
            background: url('../states/maharashtra.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [76.35715384729752, 18.7555419329087], // starting position [lng, lat]
        zoom: 5.8, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='maharashtra'";
