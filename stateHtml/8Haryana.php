...
<head>
    ...
    <style>
        body {
            background: url('../states/haryana.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [76.38486095197394, 29.452876949909978], // starting position [lng, lat]
        zoom: 7, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='haryana'";
