...
<head>
    ...
    <style>
        body {
            background: url('../states/karnataka.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [75.78913868332754,15.218031581048817 ], // starting position [lng, lat]
        zoom: 5.9, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='karnataka'";
