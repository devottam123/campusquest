...
<head>
    ...
    <title>Jammu and Kashmir | Tour</title>
    ...
    <style>
        body {
            background: url('../states/jammu&kashmir.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [74.29095449368904, 34.66433807294651], // starting position [lng, lat]
        zoom: 6.2, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='jammu and kashmir'";
