   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [74.05411074125931,15.35555582420926], // starting position [lng, lat]
        zoom: 8.8, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='Goa'";
		$rs=mysqli_query($con,$s);
		while($r=mysqli_fetch_array($rs))
		{
	  echo"<script>
      const popup".$r[0]." = new mapboxgl.Popup().setHTML(
        '<b>".$r[1]."</b><br><a href=".$r[2].">Virtual Tour</a><br><a href=".$r[3].">Website</a><br><a href=".$r[4].">Gallery</a><brClick on the above links to see the Virtual Tour, Website and Photos of the College.'
      );
