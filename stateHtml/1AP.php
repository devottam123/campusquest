...
<head>
    ...
    <title>Andhra Pradesh | Tour</title>
    ...
    <style>
        body {
            background: url('../states/andhrapradesh.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [80.46247886872724,16.518031581048817 ], // starting position [lng, lat]
        zoom: 5.8, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='andhra pradesh'";
