...
<head>
    ...
    <style>
        body {
            background: url('../states/telangana.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [79.01477601973153, 18.060271012202912], // starting position [lng, lat]
        zoom: 6.7, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='telangana'";
