...
<head>
    ...
    <style>
        body {
            background: url('../states/chhatisgarh.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [81.94413813840185 , 21.223233138862423], // starting position [lng, lat]
        zoom: 6, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='chattishgarh'";
