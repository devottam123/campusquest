...
<head>
    ...
    <style>
        body {
            background: url('../states/assam.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [93.01026591527994,26.344366845468357 ], // starting position [lng, lat]
        zoom: 6.2, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='Assam'";
