...
<head>
    ...
    <style>
        body {
            background: url('../states/punjab.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [75.48634195372244, 31.025163975162172], // starting position [lng, lat]
        zoom: 7, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='punjab'";
