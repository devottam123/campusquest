...
<head>
    ...
    <style>
        body {
            background: url('../states/lakshdweep.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [72.63132808574769, 10.565284729740696], // starting position [lng, lat]
        zoom: 13, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='lakshadweep'";
