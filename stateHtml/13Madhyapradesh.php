...
<head>
    ...
    <title>Madhya Pradesh  | Tour</title>
    ...
    <style>
        body {
            background: url('../states/madhyapradesh.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [78.5000009080145, 23.567288339165188], // starting position [lng, lat]
        zoom: 5.8, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='madhya pradesh'";
