...
<head>
    ...
    <style>
        body {
            background: url('../states/manipur.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [93.76009390975662, 24.93774943552451], // starting position [lng, lat]
        zoom: 7.6, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='manipur'";
