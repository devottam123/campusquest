...
<head>
    ...
    <style>
        body {
            background: url('../states/mizoram.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [92.81586620726944, 23.307676321624015], // starting position [lng, lat]
        zoom: 7.25, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='mizoram'";
