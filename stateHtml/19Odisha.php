...
<head>
    ...
    <style>
        body {
            background: url('../states/orissa.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [84.5259379566728,20.232931805216694], // starting position [lng, lat]
        zoom: 6.3, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='odisha'";
