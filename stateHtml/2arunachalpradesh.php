...
<head>
    ...
    <title>Arunachal Pradesh | Tour</title>
    ...
    <style>
        body {
            background: url('../states/arunachalpradesh.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [94.54597941814756,28.366799659426036], // starting position [lng, lat]
        zoom: 6.4, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='arunachal pradesh'";
		$rs=mysqli_query($con,$s);
		while($r=mysqli_fetch_array($rs))
		{
	  echo"<script>
      const popup".$r[0]." = new mapboxgl.Popup().setHTML(
        '<b>".$r[1]."</b><br><a href=".$r[2].">Virtual Tour</a><br><a href=".$r[3].">Website</a><br><a href=".$r[4].">Gallery</a><br>University Rd<br>Click on the above links to see the Virtual Tour, Website and Photos of the College.'
      );
