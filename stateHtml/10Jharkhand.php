...
<head>
    ...
    <style>
        body {
            background: url('../states/jharkhand.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [85.81491384157239, 23.57252198492257], // starting position [lng, lat]
        zoom: 6.7, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='jharkhand'";
