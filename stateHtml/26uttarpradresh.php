...
<head>
    ...
    <title>Uttar Pradesh | Tour</title>
    ...
    <style>
        body {
            background: url('../states/uttarpradesh.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [80.50194289547636, 27.340831482208458], // starting position [lng, lat]
        zoom: 5.9, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='uttar pradesh'";
