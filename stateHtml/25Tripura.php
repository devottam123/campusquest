...
<head>
    ...
    <style>
        body {
            background: url('../states/tripura.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [91.8160956340156, 23.77376399278785], // starting position [lng, lat]
        zoom: 8, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='tripura'";
