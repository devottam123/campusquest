...
<head>
    ...
    <style>
        body {
            background: url('../states/puducherry.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [79.82999995102335, 11.92999994127078], // starting position [lng, lat]
        zoom: 10, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='puducherry'";
