...
<head>
    ...
    <style>
        body {
            background: url('../states/nagaland.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [94.50992193139564, 26.220166174911475], // starting position [lng, lat]
        zoom: 7.7, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='nagaland'";
