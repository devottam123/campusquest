...
<head>
    ...
    <style>
        body {
            background: url('../states/bihar.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [86.088978613693,25.77664549850374], // starting position [lng, lat]
        zoom: 6.5, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='bihar'";
