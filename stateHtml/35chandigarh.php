...
<head>
    ...
    <style>
        body {
            background: url('../states/chandigarh.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [76.77971405253544, 30.733441943073387], // starting position [lng, lat]
        zoom: 11.5, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='chandigarh'";
