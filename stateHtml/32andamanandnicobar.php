...
<head>
    ...
    <title>Andaman and Nicobar Islands  | Tour</title>
    ...
    <style>
        body {
            background: url('../states/andaman&nicobarislands.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [92.73233400798568, 12.099714911507203], // starting position [lng, lat]
        zoom: 7, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='andaman and nicobar islands'";
		$rs=mysqli_query($con,$s);
		while($r=mysqli_fetch_array($rs))
		{
	  echo"<script>
      const popup".$r[0]." = new mapboxgl.Popup().setHTML(
        '<b>".$r[1]."</b><br><a href=".$r[2].">Virtual Tour</a><br><a href=".$r[3].">Website</a><br><a href=".$r[4].">Gallery</a><br>Click on the above links to see the Virtual Tour, Website and Photos of your College.'
      );
