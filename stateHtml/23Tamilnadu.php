...
<head>
    ...
    <style>
        body {
            background: url('../states/tamilnadu.jpg');
   ...
   <div class="lx">
    ...
    <script>
      ...
      const map = new mapboxgl.Map({
        ...
        center: [78.68085201639917, 10.899998618405203], // starting position [lng, lat]
        zoom: 6.3, // starting zoom
      });
      </script>
	  <?php
	  include("connect.php");
			$s="select * from locations where state='tamil nadu'";
