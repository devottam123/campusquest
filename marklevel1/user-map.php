...
?>
    <style>
        ...
        #map { position:absolute;left: 21.5%; top:270%;; bottom:0px;height:550px ;width:50%; margin:auto; }
        .geocoder {
		...
		<table cellpadding="10">
			<tr>
				<td><a href="user-map.php">New Registration</a>
    ...
    <div class="container">
        <form action="" id="signupForm">
            ...
            <input type="text" id="youtube" name="youtube" placeholder="Your Youtube Link..">
...
<link rel="stylesheet" href="https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.css" type="text/css">
 ...
 var saved_markers = <?= get_saved_locations() ?>;
        ...
        mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2b3R0YW0xMjMiLCJhIjoiY2wyMWs1aGpyMTZ2ejNjbWswdWZqaGYycSJ9.6SKRMXFQ8YbGsIUNijGxQw';
