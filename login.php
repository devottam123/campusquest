<?php
 if(isset($_POST['b']))
 {
	...
	if($t==1)
		...
		echo"<script>alert('INVALID ID AUR PASSWORD')</script>";
...
<head>
    ...
    <title>Campus Quest | Login</title>
    <style>
        /* header */
        header{
    ...
    <div class="ak">
        ...
        <div class="container">
            ...
            <form action="login.php" method="post">
                ...
                <div>
                    E-mail: <input type="text" name="t1" class="box">
                </div>
                <br>
                <div>
                    Password: <input type="password" name="t2" class="box">
                </div>
                <br>
                <input class="btnak" type="submit" name="b" value="Log In">
